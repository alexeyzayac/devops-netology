# Домашнее задание к занятию 3 «Управляющие конструкции в коде Terraform» - `Заяц Алексей`
...
Код для данной машины с созданиями диска описан в файле [06_disk-vm.tf](src/06_disk-vm.tf)
...
Создан файл-шаблон [hosts.tftpl](src/hosts.tftpl) и файле ansible [07_ansible.tf](src/07_ansible.tf).
...
Файл output [08_outputs.tf](src/08_outputs.tf)
